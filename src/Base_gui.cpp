...
Main_frame::Main_frame( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxFrame( parent, id, title, pos, size, style )
{
	...
	m_staticText12 = new wxStaticText( sbSizer3->GetStaticBox(), wxID_ANY, wxT("Image matrix size:"), wxDefaultPosition, wxDefaultSize, 0 );
	m_staticText12->Wrap( -1 );
	bSizer13->Add( m_staticText12, 0, wxALIGN_CENTER_VERTICAL|wxTOP|wxBOTTOM|wxLEFT, 5 );
	
	Spin_matrix_w = new wxSpinCtrl( sbSizer3->GetStaticBox(), wxID_ANY, wxEmptyString, wxDefaultPosition, wxDefaultSize, wxSP_ARROW_KEYS, 1, 20, 2 );
	bSizer13->Add( Spin_matrix_w, 0, wxALL|wxALIGN_CENTER_VERTICAL, 5 );
	
	m_staticText13 = new wxStaticText( sbSizer3->GetStaticBox(), wxID_ANY, wxT("⨯"), wxDefaultPosition, wxDefaultSize, 0 );
	m_staticText13->Wrap( -1 );
	bSizer13->Add( m_staticText13, 0, wxALIGN_CENTER_VERTICAL|wxTOP|wxBOTTOM|wxRIGHT, 5 );
	
	Spin_matrix_h = new wxSpinCtrl( sbSizer3->GetStaticBox(), wxID_ANY, wxEmptyString, wxDefaultPosition, wxDefaultSize, wxSP_ARROW_KEYS, 1, 20, 1 );
	...
	Text_image_1 = new wxStaticText( sbSizer3->GetStaticBox(), wxID_ANY, wxT("Displayed image width:"), wxDefaultPosition, wxDefaultSize, 0 );
	Text_image_1->Wrap( -1 );
	bSizer12->Add( Text_image_1, 0, wxALIGN_CENTER_VERTICAL|wxTOP|wxBOTTOM|wxLEFT, 5 );
	
	Spin_imgres_w = new wxSpinCtrl( sbSizer3->GetStaticBox(), wxID_ANY, wxEmptyString, wxDefaultPosition, wxDefaultSize, wxSP_ARROW_KEYS, 1, 64000, 200 );
	Spin_imgres_w->SetMinSize( wxSize( 100,-1 ) );
	
	bSizer12->Add( Spin_imgres_w, 0, wxALIGN_CENTER_VERTICAL|wxTOP|wxBOTTOM|wxRIGHT, 5 );
	
	Text_image_2 = new wxStaticText( sbSizer3->GetStaticBox(), wxID_ANY, wxT("px, height:"), wxDefaultPosition, wxDefaultSize, 0 );
	Text_image_2->Wrap( -1 );
	bSizer12->Add( Text_image_2, 0, wxALIGN_CENTER_VERTICAL|wxTOP|wxBOTTOM, 5 );
	
	Spin_imgres_h = new wxSpinCtrl( sbSizer3->GetStaticBox(), wxID_ANY, wxEmptyString, wxDefaultPosition, wxDefaultSize, wxSP_ARROW_KEYS, 1, 48000, 300 );
	Spin_imgres_h->SetMinSize( wxSize( 100,-1 ) );
	
	bSizer12->Add( Spin_imgres_h, 0, wxTOP|wxBOTTOM|wxRIGHT|wxALIGN_CENTER_VERTICAL, 5 );
	
	Text_image_3 = new wxStaticText( sbSizer3->GetStaticBox(), wxID_ANY, wxT("px."), wxDefaultPosition, wxDefaultSize, 0 );
	Text_image_3->Wrap( -1 );
	bSizer12->Add( Text_image_3, 0, wxALIGN_CENTER_VERTICAL|wxTOP|wxBOTTOM|wxRIGHT, 5 );
	
	wxStaticBoxSizer* sbSizer31;
	sbSizer31 = new wxStaticBoxSizer( new wxStaticBox( sbSizer3->GetStaticBox(), wxID_ANY, wxT("width presets") ), wxHORIZONTAL );
	
	preset_small = new wxButton( sbSizer31->GetStaticBox(), wxID_ANY, wxT("small"), wxDefaultPosition, wxDefaultSize, 0 );
	sbSizer31->Add( preset_small, 0, wxALL, 5 );
	
	preset_big = new wxButton( sbSizer31->GetStaticBox(), wxID_ANY, wxT("BIG"), wxDefaultPosition, wxDefaultSize, 0 );
	sbSizer31->Add( preset_big, 1, wxALL|wxEXPAND, 5 );
...
Dialog_about::Dialog_about( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxDialog( parent, id, title, pos, size, style )
{
	...
	Text_title_2->Wrap( -1 );
	Text_title_2->SetFont( wxFont( 14, wxFONTFAMILY_DEFAULT, wxFONTSTYLE_NORMAL, wxFONTWEIGHT_NORMAL, false, wxEmptyString ) );
...
Panel_image::Panel_image( wxWindow* parent, wxWindowID id, const wxPoint& pos, const wxSize& size, long style ) : wxPanel( parent, id, pos, size, style )
{
	...
	Check_preview = new wxCheckBox( Group_image->GetStaticBox(), ID_CHECK_PREVIEW, wxT("Show preview"), wxDefaultPosition, wxDefaultSize, 0 );
	Check_preview->SetValue(true); 
	Group_image->Add( Check_preview, 0, wxTOP|wxRIGHT|wxLEFT, 5 );
	
	Image_space = new wxPanel( Group_image->GetStaticBox(), wxID_ANY, wxDefaultPosition, wxDefaultSize, wxFULL_REPAINT_ON_RESIZE|wxTAB_TRAVERSAL );
	...
	Line_image = new wxStaticLine( Group_image->GetStaticBox(), wxID_ANY, wxDefaultPosition, wxDefaultSize, wxLI_HORIZONTAL );
	Group_image->Add( Line_image, 0, wxEXPAND | wxALL, 5 );
	
	File_picker = new wxFilePickerCtrl( Group_image->GetStaticBox(), wxID_ANY, wxEmptyString, wxT("Select a file"), wxT("All image files | *.bmp;*.BMP;*.gif;*.GIF;*.jpg;*.JPG;*.jpeg;*.JPEG;*.pcx;*.PCX;*.png;*.PNG;*.tga;*.TGA;*.tif;*.TIF;*.tiff;*.TIFF;*.bmp;*.BMP|All files (*.*)|*.*"), wxDefaultPosition, wxDefaultSize, wxFLP_CHANGE_DIR|wxFLP_DEFAULT_STYLE );
	Group_image->Add( File_picker, 0, wxALL|wxEXPAND, 5 );
	
	Check_use = new wxCheckBox( Group_image->GetStaticBox(), ID_USE_IMAGE, wxT("Use the image"), wxDefaultPosition, wxDefaultSize, 0 );
